<?php
use OnLibrary\Database\AuthorRepository as Repository;
...
class AuthorResource extends \BaseController
{
    /** Database repository */
    private $repo;
    ...
    {
        try {
            return $this->repo->create(Input::get('author'));
...
}//end class AuthorResource

//end file AuthorResource.php
