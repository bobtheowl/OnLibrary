<?php
use OnLibrary\Database\PublisherRepository as Repository;
...
class PublisherResource extends \BaseController
{
    /** Database repository */
    private $repo;
    ...
    {
        try {
            return $this->repo->create(Input::get('publisher'));
...
}//end class PublisherResource

//end file PublisherResource.php
